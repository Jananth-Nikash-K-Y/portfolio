...
const About: React.FC = () => {
  ...
  const stats = [
    { icon: <Code size={24} />, value: '5+', label: 'Years Experience' },
    { icon: <BrainCircuit size={24} />, value: '15+', label: 'AI Projects' },
    { icon: <Terminal size={24} />, value: '30+', label: 'Applications Built' },
    { icon: <Database size={24} />, value: '15+', label: 'Databases Managed' },
  ];

  return (
    <section id="about" className="py-20 bg-gray-100/80 dark:bg-gray-900/50">
        ...
        >
          <div className="space-y-6">
            ...
            <div className="pt-4">
              <a 
                href="#contact" 
                className="text-purple-500 dark:text-purple-400 font-medium hover:text-purple-600 dark:hover:text-purple-300 transition-colors flex items-center gap-2"
              >
          ...
          <div className="relative">
            ...
            <div className="relative h-full bg-white dark:bg-gray-800 rounded-lg p-8 shadow-sm">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-4">
                  {stats.map((stat, index) => (
                    <div key={index} className="text-center">
                      <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gray-100 dark:bg-gray-900 mb-3 text-purple-500">
                        {stat.icon}
                      </div>
